...
public class HeaderLayoutManagerFixed extends RecyclerView.LayoutManager {
     ...
     * @see #recycleViewsFromStart(androidx.recyclerview.widget.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(androidx.recyclerview.widget.RecyclerView.Recycler, int)
     */
